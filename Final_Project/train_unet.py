...
def train_unet(args):
    ...
    print(f"UNet trainable parameters: {sum(p.numel() for p in unet.parameters() if p.requires_grad):,}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='logs_unet',
    ...
    parser.add_argument('--train_timesteps', type=int, default=5000,
